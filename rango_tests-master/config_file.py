...
ch3 = {'Chapter3LiveServerTests.test_navigate_from_index_to_about': False,
        'Chapter3LiveServerTests.test_navigate_from_about_to_index': False,
        'Chapter3ViewTests.test_index_contains_hello_message': False,
...
ch5 = {'Chapter5LiveServerTests.test_population_script': False,
        'Chapter5LiveServerTests.test_admin_page_contains_title_url_and_category': False,
        'Chapter5LiveServerTests.test_can_create_new_category_via_admin_site': False,
        'Chapter5ModelTests.test_create_a_new_category': False,
...
ch6 = {'Chapter6ModelTests.test_category_contains_slug_field': False,
        ...
        #'Chapter6LiveServerTests.test_category_on_admin_page_contains_slug_field': False,
        'Chapter6LiveServerTests.test_category_redirect_to_desired_page': False}

ch7 = {'Chapter7LiveServerTestCase.test_form_is_saving_new_category': False,
        'Chapter7LiveServerTestCase.test_form_error_when_category_field_empty': False,
        'Chapter7LiveServerTestCase.test_add_category_that_already_exists': False,
        'Chapter7LiveServerTestCase.test_form_is_saving_new_page': False,
        'Chapter7LiveServerTestCase.test_cleaned_data_from_add_page': False,
        'Chapter7ViewTests.test_index_contains_link_to_add_category': False,
...
ch9 = {'Chapter9LiveServerTests.test_register_user': False,
        'Chapter9LiveServerTests.test_admin_contains_user_profile': False,
        'Chapter9LiveServerTests.test_links_in_index_page_when_logged': False,
        'Chapter9LiveServerTests.test_links_in_index_page_when_not_logged': False,
        'Chapter9LiveServerTests.test_logout_link': False,
        'Chapter9LiveServerTests.test_add_category_when_logged': False,
        'Chapter9LiveServerTests.test_add_page_when_logged': False,
        'Chapter9LiveServerTests.test_add_page_when_not_logged': False,
        'Chapter9LiveServerTests.test_access_restricted_page_when_logged': False,
        'Chapter9LiveServerTests.test_access_restricted_page_when_not_logged': False,
        'Chapter9LiveServerTests.test_logged_user_message_in_index': False,
        'Chapter9ModelTests.test_user_profile_model': False,
